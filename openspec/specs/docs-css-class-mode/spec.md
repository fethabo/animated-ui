# docs-css-class-mode Specification

## Purpose

Definir los requerimientos para la documentación del modo de uso mediante clases CSS puras y la configuración de accesibilidad (opt-out de prefers-reduced-motion).
