# docs-i18n Specification

## Purpose

Definir la internacionalización de la web de documentación: el idioma como primer segmento de ruta y seleccionable en el header, la existencia de todo el contenido visible en español e inglés, y la validación en build que rompe ante traducciones faltantes o huérfanas.
