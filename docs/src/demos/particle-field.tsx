...
export const controls: DemoControl[] = [
  ...
  { prop: 'count', type: 'number', min: 10, max: 200, step: 10, default: 90, override: 'elección del demo para que la prop sea observable; el test-app también diverge del default' },
  { prop: 'links', type: 'boolean', default: true, override: 'prop encendida para que el demo la muestre; apagada por default en la librería' },
