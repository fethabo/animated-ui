...
export const controls: DemoControl[] = [
  { prop: 'count', type: 'number', min: 4, max: 40, step: 2, default: 12, override: 'valor propio del demo para que el efecto se lea dentro del frame de la docs (el test-app usa el default de la librería)' },
  { prop: 'spread', type: 'number', min: 20, max: 160, step: 10, default: 80, override: 'valor propio del demo para que el efecto se lea dentro del frame de la docs (el test-app usa el default de la librería)' },
