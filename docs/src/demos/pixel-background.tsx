...
export const controls: DemoControl[] = [
  {
    ...
    default: ['hover', 'idle'],
    override: 'elección del demo para que la prop sea observable; el test-app también diverge del default',
  },
  { prop: 'color', type: 'color', default: '#7c3aed' },
  { prop: 'cellSize', type: 'number', min: 6, max: 32, step: 2, default: 14, override: 'valor propio del demo para que el efecto se lea dentro del frame de la docs (el test-app usa el default de la librería)' },
